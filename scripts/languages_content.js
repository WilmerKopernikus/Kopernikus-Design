...
const languagesContent = {
   en: {
    ...
    //index
    indexTitle: `WEBSITES THAT TURN <br>VISITORS INTO CUSTOMERS`,
    indexSubtitle: `DESIGN - DEVELOPMENT - SEO <br> FOR BUSINESSES THAT WANT RESULTS`,
  ...
  de: {
    ...
    //Index
    indexTitle: `WEBSEITEN, DIE BESUCHER <br> IN KUNDEN VERWANDELN`,
    indexSubtitle: `DESIGN - ENTWICKLUNG - SEO <br> FÜR UNTERNEHMEN, DIE ERGEBNISSE WOLLEN`,
  ...
  es: {
    ...
    //Index
    indexTitle: 'SITIOS WEB QUE CONVIERTEN <br> VISITAS EN CLIENTES',
    indexSubtitle: 'DISEÑO - DESARROLLO - SEO <br> PARA EMPRESAS QUE QUIEREN RESULTADOS',
