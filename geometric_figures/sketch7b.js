let sketch7b = function (p) {
  ...
  let p5Instance7b = new p5(sketch7b, 'sketch7b');

  // Attach the p5 instance to the container
  let canvasContainer7b = document.getElementById('sketch7b');
  canvasContainer7b.sketchInstance = p5Instance7b;
  
  // Set up an Intersection Observer to manage noLoop/loop
  let observer7b = new IntersectionObserver((entries) => {
    ...
    // Start observing
  observer7b.observe(canvasContainer7b);
